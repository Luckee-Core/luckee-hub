...
import { connectTerminalWebSocket } from '@/api/dev-hub';

type DevHubTerminalSessionPanelProps = {
  sessionId: string;
  isActive: boolean;
  dockOpen: boolean;
};
 ...
 */
export const DevHubTerminalSessionPanel = ({
  sessionId,
  isActive,
  dockOpen,
}: DevHubTerminalSessionPanelProps) => {
