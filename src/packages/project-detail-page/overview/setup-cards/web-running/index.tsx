...
export const WebRunning = () => {
  ...
  const ok = useMemo(() => !!webUrl, [webUrl]);

  if (!webRepo || webRepo.depsInstalled !== true) {
    return null;
  }
  ...
  return (
    <div className={styles.card}>
      ...
      <span className={ok ? styles.labelOk : styles.labelPending}>Web running</span>
      <p className={styles.description}>
        The Next.js dev server is listening on the configured port.
      </p>
    </div>
  );
};
